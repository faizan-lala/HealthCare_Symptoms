        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="animate-slide-up">
            <div className="flex items-center justify-center lg:justify-start">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg animate-glow">
            ...
            <h2 className="mt-8 text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">
              Welcome back! 👋
            </h2>
          </div>
          ...
          <div className="mt-10">
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="mt-6 text-base text-gray-600 dark:text-gray-300 text-center">
