              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                {commonSymptoms.slice(0, 12).map((symptom) => (
                  <button
                    ...
                    className="p-3 text-left bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 transition-colors group"
                  >
                    <div className="text-sm font-medium">{symptom.name}</div>
                    {symptom.source === 'user' && symptom.frequency > 0 && (
                      <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Used {symptom.frequency} times
                      </div>
                    )}
                  </button>
                ))}
